  ...
  return (
    <AppContext.Provider value={{ pengguna, setPengguna }}>
      ...
      <Routes>
        <Route
          path="/Aksess"
          element={token ? <Aksess /> : <Navigate replace to="/Gethelp" />}
        ></Route>
        ...
        <Route
          path="/education/students/bulliedQuiz"
          element={<BulliedQuiz />}
        />
        <Route
          path="/education/students/studentsQuiz"
          element={<StudentsQuiz />}
        />
        <Route
          path="/education/students/teacherQuiz"
          element={<TeacherQuiz />}
        />
      </Routes>
      <Rout />
